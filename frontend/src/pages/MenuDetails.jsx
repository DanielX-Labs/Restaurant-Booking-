      ...
      <div className="public-container pb-16">
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-3xl bg-gradient-to-r from-orange-500 to-amber-500 p-6 shadow-xl shadow-orange-500/20">
              <div className="flex items-center justify-between mb-4">
                <span className="text-white text-lg font-semibold">
                  Total Amount
                </span>
                <span className="text-white text-3xl font-bold">₦{Number(menu.price).toLocaleString()}</span>
              </div>
