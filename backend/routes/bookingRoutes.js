...
import { cancelUserBooking, createBooking, getAllBookings, getUserBookings, updateBookingStatus } from "../controllers/bookingController.js";
...
bookingRoutes.put("/cancel/:bookingId",protect,cancelUserBooking);
